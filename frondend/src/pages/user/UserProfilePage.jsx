...
//       const token = localStorage.getItem('access');
//       try {
//         const response = await axios.get('http://localhost:8000/posts/list-posts/', {
//           headers: {
//             'Authorization': `Bearer ${token}`,
//           },
//         });
...
//         <ProfileContainer>
//           <ProfilePhoto>
//             <img src={profile.profile_picture || 'path_to_default_picture'} alt="Profile" />
//           </ProfilePhoto>
//           <ProfileInfo>
...
//           {posts.map((post) => (
//             <Post key={post.id}>
//               <img src={post.img} alt={post.body} />
//             </Post>
//           ))}
//         </PostsContainer>
//       </ProfileContentWrapper>
