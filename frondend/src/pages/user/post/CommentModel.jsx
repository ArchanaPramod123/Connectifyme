...
//     try {
//       await axios.delete(`http://127.0.0.1:8000/post/comment-delete/${commentId}/`, {
//         headers: {
//           Authorization: `Bearer ${getToken()}`,
//         },
//       });
...
//         }
//       );
//       setComments(comments.map((comment) => (comment.id === editingComment ? response.data : comment)));
...
//                     <p>{comment.body}</p>
//                     <span className="text-gray-500 text-sm">{comment.created_time} ago</span>
//                   </CommentText>
//                 </CommentContent>
//                 <MenuButton onClick={() => setShowMenu(comment.id === showMenu ? null : comment.id)}>
//                   <FaEllipsisV />
//                   <Menu show={comment.id === showMenu}>
//                     <MenuItem onClick={() => handleUpdateComment(comment.id, comment.body)}>
//                       <FaEdit /> Update
//                     </MenuItem>
