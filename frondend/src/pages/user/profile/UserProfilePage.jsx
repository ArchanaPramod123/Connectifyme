...
//           `http://localhost:8000/post/profile/${userId ? userId : ""}`,
//           {
//             headers: {
...
//         `http://localhost:8000/post/follow-unfollow/${userId}/`,
//         {},
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
const UserProfilePage = () => {
    ...
    const handleFollowToggle = async () => {
        ...
        try {
            ...
            // // Create chat room after following
    ...
    const handleProfileUpdate = (updatedProfile) => {
        setProfile((prevProfile) => ({
            ...prevProfile,
            ...updatedProfile,
            profile_picture: updatedProfile.profile_picture || prevProfile.profile_picture // Keep the current profile picture if not updated
        }));
        setShowEditProfileModal(false);
    };
