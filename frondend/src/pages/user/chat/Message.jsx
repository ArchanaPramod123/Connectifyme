                  ...
                  <ChatInput>
                    <div className="relative flex items-center w-full p-2">
                      <input
                        ...
                        className="w-full py-2 pl-10 text-sm text-black bg-white border border-gray-200 rounded-md focus:outline-none focus:bg-white focus:placeholder-gray-400"
                        value={inputMessage}
                        onChange={(e) => setInputMessage(e.target.value)}
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
                      ...
                      <div className="absolute inset-y-0 flex items-center">
                        ...
                        >
                          ...
                          <FaPaperclip className="ml-3 text-gray-400" />
                          <input
                            id="media-upload"
                            name="media-upload"
                            type="file"
                      ...
                      <button
                        type="submit"
                        className="ml-2 px-4 py-1 text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none"
                        onClick={handleSendMessage}
                      >
                        Send
                      </button>
